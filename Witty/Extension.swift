...
let TealConstantColor = UIColor(red: 254/255, green: 72/255, blue: 72/255, alpha: 1)
//934BFF
...
let LightBlackColor =  UIColor(red: 225/255, green: 228/255, blue: 233/255, alpha: 1)
...
class AboutView: UIViewController{
    ...
    lazy var webView: WKWebView = {
        ...
        view.load(URLRequest(url: URL(string: urlItem!)!))
...
class AboutViewConfirm: UIViewController{
    override func viewDidLoad() {
        super.viewDidLoad()
    ...
    let webView: WKWebView = {
        let view = WKWebView()
        view.backgroundColor = UIColor(red: 30/255, green: 30/255, blue: 30/255, alpha: 1)
        view.load(URLRequest(url: URL(string: "https://witty.flycricket.io/terms.html")!))
//        view.load(URLRequest(url: URL(string: "https://apps.apple.com/us/app/id1514249158")!))
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    fileprivate let startButton: UIButton = {
        ...
        button.setAttributedTitle(NSAttributedString(string: "Agree",attributes: [NSAttributedString.Key.foregroundColor: UIColor.white, NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16, weight: .bold)]), for: .normal)
